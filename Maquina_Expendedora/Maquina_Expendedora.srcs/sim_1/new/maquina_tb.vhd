...
signal producto_ok, dinero_ok, reset_n, dinero_devuelto, led_standby, led_prod_entregado, led_trabajando, led_prod_ok, led_dinero_dev : std_logic;
constant CLK_PERIOD : time := 100 ms;
begin

uut : maquina port map (
    producto_ok => producto_ok, dinero_ok => dinero_ok, clk => clk, clk_2Hz => clk_2Hz, reset_n => reset_n, dinero_devuelto => dinero_devuelto,
